...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { address: @home.address, city: @home.city, state: @home.state, zip: @home.zip }
    end
  ...
  test "should update home" do
    patch :update, id: @home, home: { address: @home.address, city: @home.city, state: @home.state, zip: @home.zip }
    assert_redirected_to home_path(assigns(:home))
  end
